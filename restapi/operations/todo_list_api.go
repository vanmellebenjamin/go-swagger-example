...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		TodosGetOneHandler: todos.GetOneHandlerFunc(func(params todos.GetOneParams) middleware.Responder {
		...
		TodosUploadFileHandler: todos.UploadFileHandlerFunc(func(params todos.UploadFileParams) middleware.Responder {
...
type TodoListAPI struct {
	...
	TodosGetOneHandler todos.GetOneHandler
	...
	// TodosUploadFileHandler sets the operation handler for the upload file operation
	TodosUploadFileHandler todos.UploadFileHandler
...
func (o *TodoListAPI) Validate() error {
	...
	if o.TodosGetOneHandler == nil {
		unregistered = append(unregistered, "todos.GetOneHandler")
	}
	if o.TodosUpdateOneHandler == nil {
		unregistered = append(unregistered, "todos.UpdateOneHandler")
	}
	if o.TodosUploadFileHandler == nil {
		unregistered = append(unregistered, "todos.UploadFileHandler")
	}
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/{id}"] = todos.NewGetOne(o.context, o.TodosGetOneHandler)
