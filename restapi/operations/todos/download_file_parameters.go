...
func (o *DownloadFileParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadFileParams) validateUUID(formats strfmt.Registry) error {
