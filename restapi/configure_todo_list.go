...
import (
	...
	"flightAPI/restapi/operations"
	"flightAPI/restapi/operations/todos"
)

//go:generate swagger generate server --target ..\..\flightAPI --name TodoList --spec ..\server\swagger.yaml --principal interface{}
...
func configureAPI(api *operations.TodoListAPI) http.Handler {
	...
	// todos.UploadFileMaxParseMemory = 32 << 20
	...
	if api.TodosDeleteFileHandler == nil {
	...
	if api.TodosDownloadFileHandler == nil {
	...
	if api.TodosGetOneHandler == nil {
		api.TodosGetOneHandler = todos.GetOneHandlerFunc(func(params todos.GetOneParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.GetOne has not yet been implemented")
		})
	}
	...
	if api.TodosUploadFileHandler == nil {
		api.TodosUploadFileHandler = todos.UploadFileHandlerFunc(func(params todos.UploadFileParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.UploadFile has not yet been implemented")
		})
	}
