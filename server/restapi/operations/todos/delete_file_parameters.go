...
func (o *DeleteFileParams) bindUUID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteFileParams) validateUUID(formats strfmt.Registry) error {
